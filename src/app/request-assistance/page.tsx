...
export default function AssistancePage() {
  ...
  return (
    <>
      ...
      <Section className="bg-sand/35"><Inner className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]"><SectionHeading title="Assistance request form" text="This form only asks for basic information needed to begin a careful, respectful review." /><ContactForm type="assistance" /></Inner></Section>

...
export default function VolunteerPage() {
  ...
  return (
    <>
      ...
      <Section className="bg-sand/35"><Inner className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]"><SectionHeading title="Apply to volunteer" text="Tell us how you would like to help. We will follow up when there is a fitting opportunity." /><ContactForm endpoint="/api/volunteer" type="volunteer" /></Inner></Section>

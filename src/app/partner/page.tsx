...
export default function PartnerPage() {
  ...
  return (
    <>
      ...
      <Section id="partnership-form" className="scroll-mt-28 bg-terracotta/10"><Inner className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]"><SectionHeading title="Start a partnership conversation" text="Tell us a little about your organization and the kind of care you hope to make possible. We would be honored to talk with you." /><ContactForm endpoint="/api/partnership" type="partnership" /></Inner></Section>
